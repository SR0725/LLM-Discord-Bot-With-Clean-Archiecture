...
import setupDiscordCommandHandlers from "@/adapter/in/discord/controller";
import { AccountSwitchModelUseCase } from "@/application/port/in/account-switch-model-use-case";
import { AccountSwitchModelService } from "@/application/domain/service/account-switch-model-service";

// 初始化持久層

// 初始化服務
const accountSwitchModelUseCase: AccountSwitchModelUseCase =
  new AccountSwitchModelService();
